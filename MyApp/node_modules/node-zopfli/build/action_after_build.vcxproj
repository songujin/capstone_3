...
<Project DefaultTargets="Build" ToolsVersion="14.0" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  ...
  <PropertyGroup Label="Globals">
    <ProjectGuid>{BCB46006-6A2B-0AB7-658F-60D6076D0490}</ProjectGuid>
  ...
  <ItemGroup>
    <CustomBuild Include="$(OutDir)\zopfli.node">
      ...
      <Command>call mkdir &quot;D:\capstonepj\MyApp\node_modules\node-zopfli\lib\binding\node-v57-win32-x64&quot; 2&gt;nul &amp; set ERRORLEVEL=0 &amp; copy /Y &quot;$(OutDir)zopfli.node&quot; &quot;D:\capstonepj\MyApp\node_modules\node-zopfli\lib\binding\node-v57-win32-x64\zopfli.node&quot;&#xD;&#xA;if %errorlevel% neq 0 exit /b %errorlevel%</Command>
      <Message>Copying $(OutDir)/zopfli.node to D:/capstonepj/MyApp/node_modules/node-zopfli/lib/binding/node-v57-win32-x64\zopfli.node</Message>
      <Outputs>D:\capstonepj\MyApp\node_modules\node-zopfli\lib\binding\node-v57-win32-x64\zopfli.node</Outputs>
    </CustomBuild>
  </ItemGroup>
  <ItemGroup>
    <ProjectReference Include="zopfli.vcxproj">
      <Project>{6EBA58AC-E821-1B78-4448-9D269A0124E7}</Project>
